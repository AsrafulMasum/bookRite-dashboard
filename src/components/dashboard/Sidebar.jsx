...
const Sidebar = () => {
  ...
  return (
    <div className="min-h-screen">
      <aside className="fixed top-[30px] bottom-[30px] bg-[#E6E6FF66] rounded-tr-[16px] rounded-br-[16px] py-6 overflow-y-auto max-h-screen w-60 2xl:w-80 min-[17000px]:w-96 ">
